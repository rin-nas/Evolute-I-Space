...
1. Купить второй комлект зимних (или летних)
   * литых дисков (заходим на сайт Колесо.Ру, выбираем марку и модель автомобиля, получаем [результат поиска](https://koleso.ru/catalog/filter/discs/?discs_diameter=18&discs_pcd=5*110&discs_type%5B%5D=alloy&car_modification=2914&discs_dia=67.1&discs_et=40&discs_width=7.5))
   * шин
