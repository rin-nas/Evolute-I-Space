...
1. Очень медленная (по современным меркам) зарядка тяговой батареи через
   ...
   всего 7 киловатт (в разъёме используется одна фаза и только 5 контактов).
   Хотя стандарт Type2 поддерживает 22 KW для разъёма с 3-мя фазами и 7-ю контактами.
