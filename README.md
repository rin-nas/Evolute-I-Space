...
1. Относительно невысокая цена авто (с учётом госсубсидии)
1. Большой запас хода без дозаправок (> 1000 км.?)
...
1. Дизайн на 4 из 5
1. Очень медленная зарядка Type2 (по современным меркам)
